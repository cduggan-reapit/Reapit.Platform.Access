...
using Reapit.Platform.Access.Api.Controllers.Dummies.V1.Examples;
...
using Reapit.Platform.Access.Core.UseCases.Dummies.DeleteDummyById;
using Reapit.Platform.Access.Core.UseCases.Dummies.GetDummies;
using Reapit.Platform.Access.Core.UseCases.Dummies.GetDummyById;
using Reapit.Platform.Access.Core.UseCases.Dummies.UpdateDummy;
using Swashbuckle.AspNetCore.Filters;

namespace Reapit.Platform.Access.Api.Controllers.Dummies.V1;
